...
class ProductInCartForReadTest {
  ...
  final void equals_sameObject() throws Exception {
    ProductInCartForRead productInCart = new ProductInCartForRead("name", "decription", 1, 1d,
        "RUB");
  ...
  final void equals_matchingObject() throws Exception {
    ProductInCartForRead productInCart1 = new ProductInCartForRead("name", "decription", 1, 1d,
        "RUB");
    ProductInCartForRead productInCart2 = new ProductInCartForRead("name", "decription", 1, 1d,
        "RUB");
  ...
  final void equals_differentProductName() throws Exception {
    ProductInCartForRead productInCart1 = new ProductInCartForRead("name1", "decription", 1, 1d,
        "RUB");
    ProductInCartForRead productInCart2 = new ProductInCartForRead("name2", "decription", 1, 1d,
        "RUB");
  ...
  final void equals_differentDescription() throws Exception {
    ProductInCartForRead productInCart1 = new ProductInCartForRead("name", "decription1", 1, 1d,
        "RUB");
    ProductInCartForRead productInCart2 = new ProductInCartForRead("name", "decription2", 1, 1d,
        "RUB");
    assertNotEquals(productInCart1, productInCart2);
  }
  ...
  final void equals_differentQuantity() throws Exception {
    ProductInCartForRead productInCart1 = new ProductInCartForRead("name", "decription", 1, 1d,
        "RUB");
    ProductInCartForRead productInCart2 = new ProductInCartForRead("name", "decription", 2, 1d,
        "RUB");
    assertNotEquals(productInCart1, productInCart2);
  }
  ...
  final void equals_differentPrice() throws Exception {
    ProductInCartForRead productInCart1 = new ProductInCartForRead("name", "decription", 1, 1d,
        "RUB");
    ProductInCartForRead productInCart2 = new ProductInCartForRead("name", "decription", 1, 2d,
        "RUB");
    assertNotEquals(productInCart1, productInCart2);
  }
